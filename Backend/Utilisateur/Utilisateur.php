...
class Utilisateur
{
    ...
    public static function create($idf, $pass, $email, $pseudo, $prenom, $nom, $sessID) {
        /*$instance = new self($idf, $sessID);
        $instance->estSessionOwner = ($identifiant == $sessID) ? true : false;
        $instance->estConnecte = true;
